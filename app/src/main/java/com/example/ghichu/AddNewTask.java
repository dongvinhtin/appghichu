...
public class AddNewTask extends BottomSheetDialogFragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        newTaskContent = requireView().findViewById(R.id.newTaskContent);
        ...
        db = new DataProvider(getActivity());
        db.openDatabase();
        ...
        newTaskSaveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!text.trim().equals("")){
                    if(finalIsUpdate){
                        db.updateTask(bundle.getInt("id"), text, content);
                    }
                    else {
                    ...
                    Toast.makeText(getContext(),"Không được để trống tên ghi chú!",Toast.LENGTH_LONG).show();
                }
                dismiss();
            }
        });
